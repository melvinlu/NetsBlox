            ...
            SnapCloud.getPublicProject(
                ...
                function (projectData) {
                    ...
                    myself.nextSteps([
                        ...
                        function () {
                            // NetsBlox changes - start
                            if (projectData.indexOf('<project') === 0) {
                                myself.rawOpenProjectString(projectData);
                            } else {  // assume netsblox project
                                // Set up the next role, room, etc
                                var response = SnapCloud.parseResponse(projectData)[0],
                                    roleId = response.ProjectName,
                                    newRoom = response.RoomName;
                                ...
                                myself.rawOpenCloudDataString(response.SourceCode);
                            // NetsBlox changes - end
                            }
                            myself.hasChangedMedia = true;
                        },
