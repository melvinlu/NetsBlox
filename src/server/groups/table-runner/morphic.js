...
function getDocumentPositionOf(aDOMelement) {
    ...
    while (!!offsetParent) {  // jsdom problem, I think. undefined should be null...
...
Node.prototype.removeChild = function (aNode) {
    throw 'this: ' + this
    throw 'this.constructor: ' + JSON.stringify(this.constructor.name);
    throw 'this.children: ' + JSON.stringify(this.children instanceof Array);
